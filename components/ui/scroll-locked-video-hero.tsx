...
export default function MetroHero({
  ...
  useEffect(() => {
    ...
    // Arrow const, not a hoisted `function` declaration: TypeScript drops the
    // non-null narrowing of `video` inside hoisted declarations, so a `function`
    // here fails `strict` with TS18047.
